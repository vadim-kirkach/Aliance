...
<section class="section about">
 ...
 <div class="swiper black-slider">
  <!-- Additional required wrapper -->
  <ul class="swiper-wrapper black-header-features">
    <!-- Slides -->
    <li class="swiper-slide black-header-features-item">
  ...
  <div class="about-buttons primary-buttons-wrapper">
      ...
      <div class="prod-content-wrapper">
        ...
        <div class="prod-content">
          ...
          <ul class="clients-list">
            ...
            <li class="clients-list-item">
              <svg width="30" height="30" class="client-list-icon">
                <use href="img/sprite.svg#homehim"></use>
              </svg>
              Бытовая химия
            </li>
            <li class="clients-list-item">
              <svg width="30" height="30" class="client-list-icon">
                <use href="img/sprite.svg#dezinf"></use>
              </svg>
              Дезинфицирующие средства
            </li>
            <li class="clients-list-item">
              <svg width="30" height="30" class="client-list-icon">
                <use href="img/sprite.svg#aero"></use>
              </svg>
              Пищевые аэрозоли
            </li>
            <li class="clients-list-item">
...
<div class="container">
 ...
 <div class="science-buttons primary-buttons-wrapper">
    ...
    <div class="science-button-next primary-button-next">
      <svg width="36px" height="24px">
        <use href="img/sprite.svg#arrow-next"></use>
      </svg>
    </div>
