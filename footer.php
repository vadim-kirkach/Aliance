<section class="cta">
    ...
    <div class="container">
      <div class="footer-top">
        ...
        <div class="footer-info">
          ...
          <address class="footer-info-address">г. Москва, Холодильный пер. 4к1с8
          </address>
        </div>
    ...
    <div class="container">
      <div class="footer-wrapper">
        ...
        <div class="footer-author">
          ...
          <svg class="footer-social-icon" width="52px" height="11px">
            <use href="img/sprite.svg#web"></use>
          </svg>
        </div>
      </div>
    </div>
  ...
  <div class="modal">
    <div class="modal-dialog">
      ...
      <p class="modal-text">Оставьте заявку, наш менеджер свяжется с Вами в ближайшее время ответит на все интересующие вопросы и поможем даже в самых сложных случаяx!
      </p>
  ...
  <div class="modal-success">
    <div class="modal-dialog-success">
      <a href="#" class="modal-success-close" data-toggle="modalTh">
        <svg class="close-icon" width="18px" height="18px">
          <use href="img/sprite.svg#close"></use>
        </svg>
      </a>
      ...
      <p class="modal-success-text">Наш менеджер свяжется с Вами в ближайшее время ответит на все интересующие вопросы и поможем даже в самых сложных случаях!
      </p>
      <button class="button modal-form-button" type="submit">Вернуться на главную</button>
    </div>
  </div>
